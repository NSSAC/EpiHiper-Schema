...
class EpiHiperMerger {
  ...
  async process(files, output = 'std::out') {
    ...
    if (this.instance.epiHiperSchema == 'https://github.com/NSSAC/EpiHiper-Schema/blob/master/schema/runParametersSchema.json') {
  ...
  addVariables(variables) {
    ...
    variables.forEach(function(gobalVariable) {
      this.instance.variables.push(gobalVariable);
    }.bind(this));
  };
